...
CL_k_nearest = np.load('cl_att_test.npy')
CL_k_nearest_logit = np.load('cl_att_logit_test.npy')

CL_k = np.load('cl_random_test.npy')
CL_k_logit = np.load('cl_random_logit_test.npy')
