...
class knn_cl(Model):
    ...
    def __init__(self, kg, data_process):
        ...
        self.init_forget_gate = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_info_gate = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_cell_state = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_output_gate = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_forget_gate_weight = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_info_gate_weight = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_cell_state_weight = tf.compat.v1.keras.initializers.he_normal(seed=None)
        ...
        self.init_mortality = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_lab = tf.compat.v1.keras.initializers.he_normal(seed=None)
        ...
        self.init_weight_mortality = tf.compat.v1.keras.initializers.he_normal(seed=None)
        ...
        """
        self.init_weight_att_W = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_weight_vec_a = tf.compat.v1.keras.initializers.he_normal(seed=None)
        ...
        """
        self.init_weight_vec_a_neighbor = tf.compat.v1.keras.initializers.he_normal(seed=None)
        ...
        """
        self.init_retain_b = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.init_retain_weight = tf.compat.v1.keras.initializers.he_normal(seed=None)
        ...
        """
        self.init_retain_variable_b = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.bias_retain_variable_b = tf.Variable(self.init_retain_variable_b(shape=(self.latent_dim,)))
        self.init_retain_variable_w = tf.compat.v1.keras.initializers.he_normal(seed=None)
        ...
        """
        self.init_projection_b = tf.compat.v1.keras.initializers.he_normal(seed=None)
        self.bias_projection_b = tf.Variable(self.init_projection_b(shape=(self.latent_dim,)))
        self.init_projection_w = tf.compat.v1.keras.initializers.he_normal(seed=None)
    ...
    def SGNN_loss(self):
        ...
        dot_prod_sum = tf.reduce_sum(input_tensor=dot_prod, axis=2)

        sum_log_dot_prod = tf.math.log(tf.math.sigmoid(tf.math.negative(tf.reduce_mean(input_tensor=dot_prod_sum, axis=1))))
        ...
        dot_prod_sum_positive = tf.reduce_sum(input_tensor=dot_prod_positive, axis=2)

        sum_log_dot_prod_positive = tf.math.log(tf.math.sigmoid(tf.reduce_mean(input_tensor=dot_prod_sum_positive, axis=1)))

        self.negative_sum = tf.math.negative(
            tf.reduce_sum(input_tensor=tf.math.add(sum_log_dot_prod, sum_log_dot_prod_positive)))
